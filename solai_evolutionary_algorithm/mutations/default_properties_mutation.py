...
def default_properties_mutation() -> PropertiesMutation:
    return PropertiesMutation(
        ...
        melee_property_data={
            "radius": PropertyMutationData(
                property_type=float, probability=0.1,
            ...
            "startupTime": PropertyMutationData(
                property_type=int, probability=0.1,
            ...
            "knockbackTowardPoint": PropertyMutationData(
                property_type=bool, probability=0.9,
        ...
        projectile_property_data={
            ...
            "knockbackTowardPoint": PropertyMutationData(
                property_type=bool, probability=0.1,
                mutation_factor_range=(0.5, 1.5), value_range=(False, True)
            )
        }
    )