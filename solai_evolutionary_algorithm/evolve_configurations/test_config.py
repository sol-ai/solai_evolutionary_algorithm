...
from solai_evolutionary_algorithm.evaluation.simulation.novelty_simulation_fitness_evaluation import \
    NoveltySimulationFitnessEvaluation
...
test_config = EvolverConfig(
    ...
    fitness_evaluator=FromExistingSimulationFitnessEvaluation(
        ...
        metrics=["leadChange", "characterWon",
                 # "stageCoverage",
                 "nearDeathFrames", "gameLength", "hitInteractions"],
        metrics_weights={
            "leadChange": 0.4,
            "characterWon": 0.9,
            # "stageCoverage": 0.5,
